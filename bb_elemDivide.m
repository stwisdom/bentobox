function x1Overx2_or_grad=bb_elemDivide(args,parentLabelGrad)
    ...
    switch(nargin)
        ...
        case 1
            ...
            x1Overx2=bsxfun(@rdivide,x1,x2);
            
            x1Overx2_or_grad=x1Overx2;
            
        case 2
            %%% backward pass
            
            D_wrt_x1Overx2=args.D_wrt_thisNode;
            Dsz=size(D_wrt_x1Overx2);
            Dndims=length(Dsz);
            ...
            switch(parentLabelGrad)
                ...
                case 'x1'
                    ...
                    ieq1=find(x1sz==1);
                    grad=bsxfun(@rdivide,D_wrt_x1Overx2,x2);
                    for ii=ieq1
                        grad=sum(grad,ii);
                    end
                ...
                case 'x2'
                    ...
                    ieq1=find(x2sz==1);
                    grad= -bsxfun(@times,D_wrt_x1Overx2,bsxfun(@rdivide,x1,x2.^2));
                    for ii=ieq1
                        grad=sum(grad,ii);
                    end
